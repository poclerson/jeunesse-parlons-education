...
<div id="comments" class="comments-area">
	...
	if ( have_comments() ) : ?>
		<h2 class="comments-title">
			...
			if ( '1' === $education_insight_comments_number ) {
				...
				printf( esc_html__( 'One thought on &ldquo;%s&rdquo;', 'nursery-kindergarten' ), esc_html (get_the_title() ));
			} else {
				printf(
				   esc_html(
	...
	if ( ! comments_open() && get_comments_number() && post_type_supports( get_post_type(), 'comments' ) ) : ?>
		<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'nursery-kindergarten' ); ?></p>
	<?php
	endif;
